      ...
      <div className="bg-white border rounded-lg w-80">
        ...
        <div className="collapse ">
          ...
          <div className="collapse-content">
            ...
            <button className="text-sm text-white  pl-4 pr-4 pt-1 pb-1 rounded-sm font-inter bg-primary-color">English</button>
            <button className="text-sm text-black  pl-4 pr-4 pt-1 pb-1 rounded-sm font-inter border border-primary-color">English</button>
            </div>
          </div>
        </div>
      </div>
